...
split_token = '<option value="'
dataset_id = html.split(split_token)[1].split('"')[0]
...
report_id = final.split('/analysis/reports/phase4/')[-1] if '/analysis/reports/phase4/' in final else None
print("report_id", report_id)
print("html_exists", os.path.exists(os.path.join('reports', 'generated', report_id + '.html')) if report_id else False)
print("json_exists", os.path.exists(os.path.join('reports', 'generated', report_id + '.json')) if report_id else False)
